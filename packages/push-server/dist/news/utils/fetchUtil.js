...
exports.fetchNewsRequestByXueqiu = exports.fetchNewsRequestByCls = exports.fetchAllNewsRequest = exports.fetchNewsRequest = void 0;
...
async function fetchAllNewsRequest(limit = 400) {
    return new Promise(async (resolve, reject) => {
        const params = {
            headers: {
                accept: '*/*',
        ...
        (0, node_fetch_1.default)(`https://news.10jqka.com.cn/tapp/news/push/stock/?page=1&tag=&track=website&pagesize=${limit}`, params).then(async (result) => {
            resolve(await result.json());
        });
    });
}
exports.fetchAllNewsRequest = fetchAllNewsRequest;
