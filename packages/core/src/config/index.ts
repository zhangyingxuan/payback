...
export const chooseStockBaseCondition = '同花顺二级行业；股价低于30元；流通市值<=120亿；流通市值>=20亿；非创业板；非科创板；非ST';
...
export const params = {
  ...
  chooseStock1Expected: '昨日未涨停；集中度70<=11；10日内有涨停；昨日换手率；竞价情况；竞价看多；竞价高开；' + chooseStockBaseCondition,
  // chooseStock1Expected: '昨日未涨停；集中度70<=11；10日内有涨停；昨日换手率；竞价情况；竞价看多；竞价抢筹；竞价涨幅；竞价高开；' + chooseStockBaseCondition,
  // 新股
