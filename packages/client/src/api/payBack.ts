...
export const crawlTodayData = (data: any | null) => {
  return http.request<ChartResult>('post', `${baseUrl}/crawlTodayData`, {
    data,
  });
};
...
export const crawlBinddingData = (data: any | null) => {
  return http.request<ChartResult>('post', `${baseUrl}/crawlBinddingData`, {
    data,
  });
};
/**
...
export const crawlSpecialStockData = (data: any | null) => {
  return http.request<ChartResult>('post', `${baseUrl}/crawlSpecialStockData`, {
    data,
  });
};
/**
...
export const fetchEvenBoardData = (params: any | null) => {
  return http.request<ChartResult>('get', `${baseUrl}/fetchEvenBoardData`, {
    params,
  });
};

export const fetchDataHealth = () => {
  return http.request<any>('get', `${baseUrl}/fetchDataHealth`);
};
/**
 * 获取热榜数据
 * @returns
...
export const fetchHostListData = (params: any | null) => {
  return http.request<Array<any>>('get', `${baseUrl}/fetchHostListData`, {
    params,
  });
};
/**
...
export const findPlateByLimit = (params: any | null) => {
  return http.request<Array<any>>('get', `${baseUrl}/findPlateByLimit`, {
    params,
  });
};
/**
...
export const fetchPlateOrderByDailyLimit = (params: any | null) => {
  return http.request<Array<any>>(
    'get',
    `${baseUrl}/fetchPlateOrderByDailyLimit`,
    { params },
  );
};
/**
...
export const fetchReveiwDataByDate = (params: any | null) => {
  return http.request<Array<any>>('get', `${baseUrl}/fetchReveiwDataByDate`, {
    params,
  });
};
/**
...
export const findConceptPlateWithinNDays = (params: any | null) => {
  return http.request<Array<any>>(
    'get',
    `${baseUrl}/findConceptPlateWithinNDays`,
    { params },
  );
};
/**
...
export const findConceptPlateByLimit = (params: any | null) => {
  return http.request<Array<any>>('get', `${baseUrl}/findConceptPlateByLimit`, {
    params,
  });
};
