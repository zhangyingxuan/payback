<template>
  ...
  >
    <pre>
      ...
      1. 9点前，外围美股昨日涨跌情况
      2. 看集合竞价
          2.1 看匹配量，9.24到9.25一分钟可暴露主力意图（看价格走势，判断出货还是抢筹）
          2.2 <span style="color: red">一字板方向</span>，为资金追随方向，对应 <span style="color: red">板块分支</span>加关注
      3. 开盘比对昨日功课中，预期差；<span style="color: red">去弱留强</span>，快速反应！！！
