export declare const params: {
    ...
    gainianPlate: string;
    hangyePlateOrderByDailyLimitNum: string;
    gainianPlateOrderByDailyLimitNum: string;
    rlCoreStock: string;
    fundsInflowStock: string;
    fundsOutflowStock: string;
    increaseCoreStock: string;
    declineCoreStock: string;
};
