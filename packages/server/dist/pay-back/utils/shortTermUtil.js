...
function prepareDto(dailyLimitData, dailyLimitOpenData, downLimitData, todayDateStr) {
    ...
    let { board1 = 0, evenBoardData, downLimitDataArr, dailyLimitReturnSealQuantity, downLimitQuantity } = (0, transformDataUtil_1.transformShortTermSourceData)(dailyLimitData, downLimitData, todayDateStr);
