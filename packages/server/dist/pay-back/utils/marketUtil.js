...
exports.default = {
    async getMarketData(dateStr, cookie) {
        ...
        const gainianRiseFloat = (0, fetchUtil_1.fetchIwencaiApi)(config_1.params.gainianRiseFloat + commonUtil_1.ignoreGainianPlateStr, 5, cookie);
        const gainianFallFloat = (0, fetchUtil_1.fetchIwencaiApi)(config_1.params.gainianFallFloat + commonUtil_1.ignoreGainianPlateStr, 5, cookie);
        const hangyeRiseFloat = (0, fetchUtil_1.fetchIwencaiApi)(config_1.params.hangyeRiseFloat, 5, cookie);
        const hangyeFallFloat = (0, fetchUtil_1.fetchIwencaiApi)(config_1.params.hangyeFallFloat, 5, cookie);
