...
exports.default = {
    ...
    async getFundsData(dateStr) {
        ...
        const foreignFunds = (0, transformDataUtil_1.transformForeignFunds)(responseForeignFunds);
        const marketTurnover = commonUtil_1.default.getMarketTurnover(responseMarketTurnover);
