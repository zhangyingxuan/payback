  ...
  async getThsSelfStocks() {
    fetch(thsUrl.get, {
      headers: {
        ...
        pragma: 'no-cache',
        Cookie:
          '',
      },
    })
      .then(data => console.log(data))
      .catch(e => console.error(e));
